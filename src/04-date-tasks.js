...
function isLeapYear(date) {
  ...
  const month = new Date(year, 1, 29);
...
function angleBetweenClockHands(date) {
  ...
  const angleH = ((hours * 60) + minutes) * 0.5;
  const angleM = minutes * 6;
