...
function encodeToRot13(str) {
  ...
  const charCode = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';
  return str.replace(/[A-Z]/gi, (char) => charCode[upperLower.indexOf(char)]);
}
...
function getCardId(value) {
  ...
  return numbers.indexOf(value.slice(0, -1)) + suit[value[value.length - 1]];
}
